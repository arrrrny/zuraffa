...
void main() {
  ...
  test('A6: success outcome emits valid JSON on stdout with exit code 0',
      () async {
  ...
  test('A6: runtime error outcome emits valid JSON on stderr with exit code 1',
      () async {
  ...
  test('A6: notFound outcome emits valid JSON on stderr with exit code 2',
      () async {
  ...
  test('A6: conflict outcome emits valid JSON on stderr with exit code 3',
      () async {
