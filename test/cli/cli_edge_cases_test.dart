...
void main() {
  group('CLI Edge Cases', () {
    ...
    /// Uses the compiled binary directly if available, otherwise falls back to dart run.
    Future<ProcessResult> runZfa(
      List<String> args, {
    ...
    group('Entity Name Validation', () {
      ...
      test('handles entity name with spaces', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles entity name with special characters', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles very long entity name', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles numeric entity name', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
    ...
    group('Conflicting Flags', () {
      test('handles --vpcs with --pc together', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles --data with --datasource together', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles --local with --cache together', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles --repo with --service together', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles --usecases with --repo together', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles --usecases with --service together', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
    ...
    group('JSON Configuration', () {
      test('handles missing JSON config file', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles JSON with unknown fields', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
        final configFile = File('${tempDir.path}/config.json');
...
''');
      ...
      test('handles JSON with wrong type for field', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
        final configFile = File('${tempDir.path}/config.json');
...
''');
    ...
    group('stdin Input', () {
      ...
      test('handles valid JSON from stdin', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
    ...
    group('Invalid Flag Values', () {
      test('handles invalid id-field-type', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles invalid cache-policy', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles invalid type for UseCase', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles non-numeric TTL value', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
    ...
    group('Domain and Entity Conflicts', () {
      test('handles --domain with entity-based generation', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles --repo with entity-based generation', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles --service with entity-based generation', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles --usecases with entity-based generation', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles --variants with entity-based generation', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
      ...
      test('handles custom usecase without domain', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
    ...
    group('Output and File System', () {
      test('generates files with --dry-run', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
    ...
    group('Format Output', () {
      ...
      test('outputs JSON format on error', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
        final outputDir = '${tempDir.path}/lib/src';
    ...
    group('Help and Version', () {
      test('shows help with no arguments', () async {
        ...
        final result = await runZfa([], workingDirectory: tempDir.path);
      ...
      test('shows help for generate command', () async {
        final tempDir = await Directory.systemTemp.createTemp('zfa_edge_');
        addTearDown(() => tempDir.delete(recursive: true));
