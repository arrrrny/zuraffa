...
void main() {
  ...
  group('entity help inside a project', () {
    test(
      '--help prints usage and exits 0 (cwd-independent help body)',
      () async {
        // zfaProjectRoot is the zuraffa repo root, which has a pubspec.yaml;
        // this documents that the fix leaves the inside-project path intact.
        final result = await runZfaSource([
          'entity',
          '--help',
