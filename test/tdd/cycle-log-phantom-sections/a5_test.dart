...
// kind: acceptance
// description: it yields exactly one entry with the correct behavior id, kind,
//
// This test asserts the observable behavior described above. It is
// "honest red" on first execution: the paired subject at
// `package:zuraffa/tdd/cycle-log-phantom-sections/a5_subject.dart` is unimplemented, so the test fails through an
