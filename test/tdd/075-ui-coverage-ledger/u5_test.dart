...
void main() {
  group('U5 (FR-005)', () {
    test(
      'U5 - The coverage gate MUST be wireable as a merge/landing gate: an incomplete ledger blocks the landing naming the gaps (composing with the conformance verdict of 074)..',
      () {
        final Object? result = (() {
          try {
            subject.subject_u5();
