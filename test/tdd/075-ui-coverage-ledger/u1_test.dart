...
void main() {
  group('U1 (FR-001)', () {
    test('U1 - The plan MUST produce a per-feature UI surface ledger enumerating declared surfaces — static texts (quoted-literal contract), declared routes (Presentation contract row), and named affordances — each with kind, proving behavior ids, and state..', () {
      final Object? result = (() {
        try {
          subject.subject_u1();
          return null;
