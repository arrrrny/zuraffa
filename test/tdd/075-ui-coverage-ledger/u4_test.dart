...
void main() {
  group('U4 (FR-004)', () {
    test('U4 - `zfa tdd coverage` (the coverage gate) MUST emit a machine-readable JSON verdict (one line per surface: kind, proven-by, state) and exit 0 only when every row is DONE; failures name each unproven surface and its missing prover..', () {
      final Object? result = (() {
        try {
          subject.subject_u4();
          return null;
