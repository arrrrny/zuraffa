...
import 'package:zuraffa/tdd/075-ui-coverage-ledger/a4_subject.dart' as subject;

void main() {
  group('A4 (AC-4)', () {
    test(
      'A4 - it is not forced into the ledger (the ledger\'s source is the declared Presentation/route contract plus scenario surface markers, not every quotation)..',
      () {
        final Object? result = (() {
          try {
            subject.subject_a4();
