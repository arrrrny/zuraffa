...
import '../../../lib/tdd/075-ui-coverage-ledger/u8_subject.dart' as subject;

void main() {
  group('U8 (FR-008)', () {
    test('U8 - Every refusal and gate failure MUST name the surface, the ledger row, or the missing artifact with a `--> fix:` hint..', () {
      final Object? result = (() {
        try {
          subject.subject_u8();
          return null;
