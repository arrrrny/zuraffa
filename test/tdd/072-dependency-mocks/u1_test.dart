...
import 'package:zuraffa/tdd/072-dependency-mocks/u1_subject.dart' as subject;

void main() {
  group('U1 (FR-001)', () {
    test(
      'U1 — The system MUST provide `zfa mock dependency <Name>`, which reads the declared External Dependencies & Contracts row for `<Name>` and refuses non-zero with the row to add when the name is undeclared.',
      () {
        final Object? result = (() {
          try {
