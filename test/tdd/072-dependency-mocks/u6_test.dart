...
import '../../../lib/tdd/072-dependency-mocks/u6_subject.dart' as subject;

void main() {
  group('U6 (FR-006)', () {
    test('U6 — A behavior routed to a dependency mock whose mock artifacts are absent MUST be refused (or auto-generated under the loop\'s explicit generation gate) with `zfa mock dependency <Name>` named as the fix — never a silently absent test double.', () {
      final Object? result = (() {
        try {
