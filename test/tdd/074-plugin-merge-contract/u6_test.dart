...
import 'package:zuraffa/tdd/074-plugin-merge-contract/u6_subject.dart' as subject;

void main() {
  group('U6 (FR-006)', () {
    test(
      'U6 — Any conformance failure MUST roll the host back byte-identical to its pre-merge state, exit non-zero, and name the failed checks..',
      () {
        final Object? result = (() {
          try {
            subject.subject_u6();
