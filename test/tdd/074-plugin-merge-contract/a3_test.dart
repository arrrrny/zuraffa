...
import '../../../lib/tdd/074-plugin-merge-contract/a3_subject.dart' as subject;

void main() {
  group('A3 (AC-3)', () {
    test('A3 — the only changes outside the feature\'s own artifacts are regenerated barrels (no manual wiring)..', () {
      final Object? result = (() {
        try {
          subject.subject_a3();
          return null;
