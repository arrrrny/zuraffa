...
import 'package:zuraffa/tdd/074-plugin-merge-contract/u3_subject.dart' as subject;

void main() {
  group('U3 (FR-003)', () {
    test(
      'U3 — Merge MUST register the feature\'s bindings through the host\'s service locator in mock and real flavors; the DI-graph construction check MUST construct the full graph in the merged host..',
      () {
        final Object? result = (() {
          try {
            subject.subject_u3();
