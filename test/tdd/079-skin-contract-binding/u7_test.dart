...
import 'package:zuraffa/tdd/079-skin-contract-binding/u7_subject.dart' as subject;

void main() {
  group('U7 (FR-007)', () {
    test('U7 — The binding MUST be exported from the skin barrel for the Flutter shell to consume across the package boundary.', () {
      final result = (() {
        try {
