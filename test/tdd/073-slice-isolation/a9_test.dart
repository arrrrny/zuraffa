...
import 'package:zuraffa/tdd/073-slice-isolation/a9_subject.dart' as subject;

void main() {
  group('A9 (AC-9)', () {
    test(
      'A9 — it exits 0 and the JSON verdict reports self-containment, mock certification, and suite state as passing.',
      () {
        final Object? result = (() {
          try {
            subject.subject_a9();
