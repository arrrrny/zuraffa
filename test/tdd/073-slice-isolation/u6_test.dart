...
import 'package:zuraffa/tdd/073-slice-isolation/u6_subject.dart' as subject;

void main() {
  group('U6 (FR-006)', () {
    test(
      'U6 — After merge, the HOST suite MUST run green; merge reports the host-suite outcome.',
      () {
        final Object? result = (() {
          try {
