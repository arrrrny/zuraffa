...
import 'package:zuraffa/tdd/073-slice-isolation/u1_subject.dart' as subject;

void main() {
  group('U1 (FR-001)', () {
    test(
      'U1 — `zfa slice cut --feature <f> --from <host>` MUST produce a sandbox project carrying the feature\'s spec, tdd artifacts, a runnable app shell, a router harness exposing exactly the feature\'s declared routes, and DI wiring binding certified mocks for every declared dependency touchpoint.',
      () {
        final Object result = (() {
          try {
