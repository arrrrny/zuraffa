...
// kind: acceptance
// description: it refuses naming the failed check (merge requires a verified slice).
//
// This test asserts the observable behavior described above. It is
// "honest red" on first execution: the paired subject at
// `../../../lib/tdd/073-slice-isolation/a14_subject.dart` is unimplemented, so the test fails through an
