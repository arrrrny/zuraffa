...
void main() {
  ...
  List<File> receiptFiles() =>
      Directory(p.join(projectRoot, '.zfa', 'receipts'))
          .listSync()
          .whereType<File>()
          .where((f) => f.path.endsWith('.json'))
          .toList();

  test('A3: standalone di create appends a di-<target> receipt binding the '
      'written registrations and index', () async {
