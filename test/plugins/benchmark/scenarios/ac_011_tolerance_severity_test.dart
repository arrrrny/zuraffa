...
void main() {
  test('regression beyond tolerance flagged with severity', () {
    final baseline = Baseline(
      ...
      label: 'v1.0-release',
      metrics: const {'latency_p99': 100, 'memory_mb': 100},
      timestamp: DateTime.utc(2026, 8, 1),
    );

    // +15% (just beyond 10% tolerance) -> warn severity.
    final borderline = compareBaselines(baseline, const {
      'latency_p99': 115,
      'memory_mb': 100,
    }, tolerancePercent: 10);
    ...
    final severe = compareBaselines(baseline, const {
      'latency_p99': 140,
      'memory_mb': 100,
    }, tolerancePercent: 10);
    ...
    // a 20% tolerance.
    final relaxed = compareBaselines(baseline, const {
      'latency_p99': 115,
      'memory_mb': 100,
    }, tolerancePercent: 20);
