...
void main() {
  group('DependencyResolver.resolve', () {
    test(
      'U23: cross-feature entity reference produces a dependency edge '
    ...
    test(
      'U24: conflicting definitions of the same entity name across features '
      'are refused',
      () {
    ...
    test(
      'U25: cycle across bones is reported naming the member bones',
      () {
