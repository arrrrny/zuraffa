...
void main() {
  group('TuiScreenGenerator (FR-011, SC-005)', () {
    ...
    test(
      'A22 / U34: generateListScreen produces a list screen wired to the '
    ...
    test(
      'A22 / U35: generateDetailScreen produces a detail screen wired to '
    ...
    test(
      'U36 / FR-012: generated screens use only package:zuraffa and '
    ...
    test(
      'A22 / SC-005: generated screens require zero manual wiring — they '
    ...
    test('throws ArgumentError when entity has no list-returning use case', () {
      final badSpec = TuiEntitySpec(
        ...
        useCases: const [
          TuiUseCaseSpec(name: 'get', returnsType: 'BadEntity'),
        ],
      );

      expect(
        () => generator.generateListScreen(badSpec),
        throwsArgumentError,
      );
    });
