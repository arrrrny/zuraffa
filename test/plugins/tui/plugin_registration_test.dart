...
void main() {
  group('ZuraffaTuiPlugin registration (FR-010, FR-011)', () {
    test(
      'A21: ZuraffaTuiPlugin is a ZuraffaPlugin that exposes the TUI '
      'capability',
      () {
        ...
        final tuiCapabilities = plugin.capabilities
            ...
            .toList();
        expect(tuiCapabilities, hasLength(1),
    ...
    test(
      'A23: the create-tui-screens capability is discovered by zfa make '
      ...
      () async {
        ...
        for (final file in files) {
          ...
          expect(file.content!.contains('package:flutter'), isFalse,
