...
void main() {
  group('SC-003: shared conformance test', () {
    ...
    test('A24 (1): both TUIs use the same shared theme vocabulary', () {
    ...
    test('A24 (2): both TUIs use the canonical keyboard defaults (FR-006)', () {
    ...
    test('A24 (3): one configured override takes precedence while '
        'unoverridden keys retain their defaults', () {
    ...
    test('A24 (4): the entry point signature is identical across both TUIs '
        '(static contract)', () {
