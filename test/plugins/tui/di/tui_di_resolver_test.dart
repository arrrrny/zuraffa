...
void main() {
  group('TuiDiResolver (FR-008)', () {
    test('A14 / U29: get<T>() resolves via the caller-supplied '
    ...
    test('U30: resolver does NOT create its own container — it uses the '
    ...
    test('A14: tests MAY register or override bindings through the same '
        'caller-supplied container', () async {
      final getIt = GetIt.asNewInstance();
      final di = ZuraffaDIContainer(getIt: getIt);
