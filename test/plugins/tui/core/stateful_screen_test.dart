...
void main() {
  group('StatefulScreen (FR-003, SC-002)', () {
    test('A5 / U8: setState triggers a re-render with the new value', () async {
    ...
    test('U8 (continued): setState preserves unrelated state — only the '
        'affected view is invalidated', () async {
      final tester = await nocterm.NoctermTester.create(
        size: const nocterm.Size(40, 5),
      );
      addTearDown(tester.dispose);
