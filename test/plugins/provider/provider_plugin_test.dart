...
void main() {
  ...
  test('generates provider and appends to existing', () async {
    ...
    expect(
      content1.contains('Future<Listing?> getListingByBarcode(String params)'),
      isTrue,
    );
    expect(
      content1.contains(
        "import 'package:app/src/domain/entities/listing/listing.dart';",
      ),
      isTrue,
    );
    ...
    expect(
      content2.contains('Future<Listing?> getListingByBarcode(String params)'),
      isTrue,
    );
    expect(
      content2.contains('Future<List<Listing>> searchListings(String params)'),
      isTrue,
    );
