...
void main() {
  ...
  test('issue #414: zfa service method prints ✅ Success! when appending to an '
      'existing service (action=updated)', () async {
...
''');
    ...
    expect(
      ...
      reason:
          'service method must report success on stdout; '
