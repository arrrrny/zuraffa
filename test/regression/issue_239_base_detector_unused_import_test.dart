...
void main() {
  ...
  test('base_detector.dart does not import package:path/path.dart (#239)', () {
    final baseDetector = File(p.join(
      repoRoot,
      'lib',
      'src',
      'migration',
  ...
  test('base_detector.dart imports set is the minimal expected set (#239)', () {
    ...
    expect(imports, containsAll(<String>[
      "import 'dart:io';",
      "import 'package:meta/meta.dart';",
      "import 'package:glob/glob.dart';",
    ]));
    expect(imports.length, lessThanOrEqualTo(4),
        reason: 'base_detector.dart should keep its import set minimal. '
