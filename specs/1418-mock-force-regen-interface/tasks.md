...
- [x] **T001** (P1) `test/plugins/mock/mock_builder_1418_force_interface_test.dart`
...
- [x] **T002** (P1) same file — pair conformance after force (US1/SC-001,
...
- [x] **T003** (P1) same file — non-force leaves the interface
...
- [x] **T004** (P1) same file — absent interface still emitted in both
...
- [x] **T005** (P2) same file — force honors dryRun (FR-006): force +
  dry-run leaves every file byte-identical. [behavior: B5-force-dryrun]
- [x] **T006** (P2) same file — revert precedence preserved (FR-007):
...
- [x] **T007** (P2) same file — repo-derived path stability + idempotence
...
- [x] **T008** (P1) `test/utils/zuraffa_barrel_exports_mock_surface_test.dart`
...
- [x] **T009** (P2) `test/plugins/mock/mock_datasource_builder_hide_mock_barrel_test.dart`
...
- [x] **T010** (P1) `lib/src/plugins/mock/builders/mock_builder.dart` —
...
- [x] **T011** (P1) `lib/src/utils/zuraffa_barrel_exports.dart` — add the
  ...
  FR-005]
- [x] **T012** (P1) `lib/src/plugins/mock/builders/mock_datasource_builder.dart`
...
- [x] **T013** (P1) Run the pinned regression set and record results:
  ...
  All green. [SC-005]
- [x] **T014** (P2) `dart analyze` over the changed lib/test files — zero
  new issues; `dart pub get --no-example` then `dart format lib test` per
  AGENTS.md; verify zero formatting diffs remain. [SC-005]
- [x] **T015** (P2) Update the in-repo docs surface the change touches
