...
- [x] T001 In `lib/src/plugins/tdd/services/tdd_timeout.dart`, add the
...
- [x] T002 In `lib/src/plugins/tdd/services/pipeline_runner.dart`, add the
...
- [x] T003 [behavior: U-1590-1] RED first: in
...
- [x] T004 [behavior: U-1590-2] RED first: same file, assert make's plan
...
- [x] T005 [behavior: U-1590-3] RED first: same file, assert the driver's
      ...
      <pid>)`).
- [x] T006 [behavior: U-1590-4] RED first: same file, assert
...
- [x] T007 [behavior: U-1590-5] RED first: same file, assert the runTimed
...
- [x] T008 [behavior: A-1590-1] RED first: in
...
- [x] T009 [behavior: A-1590-2] RED first: same suite, make the fake zfa
...
- [x] T013 [behavior: U-1590-4] `run_driver_core.dart`: add
...
- [x] T014 [behavior: U-1590-5] `lib/src/plugins/tdd/services/step_runner.dart`:
...
- [x] T015 [behavior: A-1590-1/A-1590-2] `run_command.dart`,
...
- [x] T016 Update the machine-contract docs: `run_command.dart` library
...
- [x] T017 `dart analyze` clean on all changed files; `dart format` clean;
      re-run the affected fast-tier suites + the slow-tier run suite.

## Phase 5 — Verification

- [x] T018 Record red evidence (pre-implementation run outputs) under
