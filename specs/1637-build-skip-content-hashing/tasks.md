...
- [x] **T002** (P1) same file — the real-change scenario (AC-2/SC-002):
...
- [x] **T003** (P1) same file — the fail-safe scenarios (AC-3/AC-4,
...
- [x] **T004** (P1) same file — mechanism reuse (AC-3/FR-003, SC-007
...
- [x] **T005** (P2) same file — no-drift guards (AC-6, SC-006): the
...
- [x] **T006** (P2) `test/plugins/tdd/services/refactor_passes_test.dart`
...
- [x] **T102** (P2) `lib/src/plugins/tdd/services/build_relevance.dart`
...
- [x] **T103** (P3) spec-kit artifacts — `specs/1637-build-skip-content-hashing/`
