...
2. **Residual red at HEAD (2026-09-10, re-run on this branch)** — full
...
3. **Counter-evidence red (2026-09-10)** — plain `test: ^1.0.0`
...
- Evidence-scope preflight (the committed evidence's exact registered
  ...
  test/tdd/004-login-ui/a3_test.dart test/tdd/004-login-ui/a4_test.dart
  test/tdd/004-login-ui/a5_test.dart test/tdd/004-login-ui/a6_test.dart
