...
| U-1541-3 | Case 3's `isA<...>` assertion unguarded (1 RED pin) | guard `outcome is! Error && outcome is! Exception` emitted; the #1007 pins (`Case 1 of 3` / `Case 2 of 3` / `Case 3 of 3`, `isNot(isA<UnimplementedError>())`, one test) unchanged; nullable complex type keeps `impl(null)` |
...
| file | tests |
| -- | -- |
| `lib/src/plugins/tdd/services/contract_test_writer.dart` | `test/plugins/tdd/services/bug_1541_contract_harness_args_test.dart` (10), `test/plugins/tdd/commands/contract_satisfied_with_rejection_e2e_1541_test.dart` (3, slow), `bug_1513_contract_lane_flutter_imports_test.dart` (10), `contract_kind_1007_test.dart` (21), `bug_1443_void_contract_seam_test.dart`, `bug_1363_contract_stub_dup_args_test.dart`, `test/tdd/004-login-ui/contract_a1_test.dart` |
...
# green (post-fix)
dart test test/plugins/tdd/services/bug_1541_contract_harness_args_test.dart          # 10/10
dart test --preset=all test/plugins/tdd/commands/contract_satisfied_with_rejection_e2e_1541_test.dart  # 3/3 (slow tier)
dart test test/plugins/tdd/commands   # 533 pass
dart test test/plugins/tdd/services   # 945 pass
