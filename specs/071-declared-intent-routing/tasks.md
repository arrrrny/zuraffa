...
- [ ] T014 [US2] Parse the `**Function**` contracts bullet in `lib/src/plugins/tdd/services/spec_parser.dart` (`parseLayerContracts` gains the function layer; signatures via T003 parser). Depends on T012 (RED).
