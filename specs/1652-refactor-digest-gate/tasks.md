...
- [ ] **T101** (P1) `lib/src/plugins/tdd/services/make_post_state.dart`
...
- [ ] **T102** (P1) `lib/src/plugins/tdd/commands/run_driver_core.dart` —
...
- [ ] **T103** (P1) `lib/src/plugins/tdd/commands/refactor_command.dart` —
  ...
  FR-005/FR-007]
- [ ] **T104** (P3) doc touch: the record's role noted beside the
...
- [ ] **T201** (P1) Regression + static scope green: both new suites;
