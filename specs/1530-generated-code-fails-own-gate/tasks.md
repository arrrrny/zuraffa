...
- [x] T001 Update `lib/src/utils/zuraffa_barrel_exports.dart` —
...
- [x] T002 Update `_collectFromBarrel` — combinator-aware collection
...
- [x] T003 Update `_collectFromBarrel` recursion — resolve directory-
...
- [x] T004 [behavior: A-1530-1] RED first: in
...
- [x] T005 [behavior: A-1530-2] RED first: fixture barrel exporting
...
- [x] T006 [behavior: A-1530-3] RED first: fixture barrel with
...
- [x] T007 [behavior: A-1530-4] RED first: nested barrel
      `src/core/params/index.dart` with directory-relative
      `export 'query_params.dart';` — `QueryParams` verifies (FR-003).
- [x] T008 [behavior: U-1530-1] RED first: generated-output probe —
...
- [x] T009 [behavior: A-1530-5] RED first: create
...
- [x] T010 [behavior: A-1530-6] Idempotence: pubspec already declaring
      `zuraffa` under `dependencies:` → file byte-identical after
      `ensure` (FR-006).
- [x] T011 [behavior: A-1530-7] Comment/format preservation: fixture
...
- [x] T012 [behavior: A-1530-8] Refusals: inline `dependencies: {...}`
...
- [x] T013 [behavior: A-1530-9] No-foreign-imports no-op: run whose
      files import no `package:zuraffa/` URI → pubspec untouched
      (US2-5).
- [x] T014 Implement `lib/src/core/dependencies/pubspec_zuraffa_ensure.dart`
...
- [x] T015 Wire the ensure into `lib/src/commands/make_command.dart`'s
...
- [x] T016 [behavior: A-1530-10] RED first: end-to-end make receipt —
...
- [x] T017 [behavior: A-1530-11] RED first: in
...
- [x] T018 [behavior: A-1530-12] RED first: same fixture with NO
      `warning -` lines in the build output → receipt prints the
      explicit "no analyzer warnings reported" line (FR-008).
- [x] T019 [behavior: A-1530-13] Guard: build output WITH `error -`
...
- [x] T020 Implement the warnings block in the tolerated path of
...
- [x] T021 Regression sweep: run the full
...
- [x] T022 Probe re-run: regenerate against the exploration fixture
      ...
      `tdd/verification.md`.
- [x] T023 `dart analyze` zero new warnings on all touched files;
