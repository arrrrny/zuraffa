...
- [x] **T001** [behavior: A1] (P1) Forward-run deferral: a fresh
...
- [x] **T002** [behavior: A2] (P1) Batch-boundary scheduling: all
...
- [x] **T003** [behavior: A3] (P1) Resume-window preservation: a
...
- [x] **T004** [behavior: A4] (P2) Blocked-contract composition: a
...
- [x] **T005** [behavior: A5] (P2) Honest stop with deferred
...
- [x] **T101** (P1) `lib/src/plugins/tdd/commands/run_driver_core.dart` —
...
- [x] **T102** (P2) Update the pinned step sequences in
