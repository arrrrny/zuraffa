...
- [x] T001 In `lib/src/plugins/tdd/models/routing.dart`, add the
      ...
      (`{Type name, ...}` or `{name, ...}`).
- [x] T002 In `lib/src/plugins/tdd/models/routing.dart`, use the shared
...
- [x] T003 [behavior: U-1536-1] RED first: in
...
- [x] T004 [behavior: U-1536-2] RED first: same file, assert the
...
- [x] T005 [behavior: U-1536-3] RED first: same file, assert the
      ...
      and spec line.
- [x] T006 Implement `UnitContractParam.named` + the named-group
...
- [x] T007 [behavior: U-1536-4] RED first: assert the subject writer
...
- [x] T008 [behavior: U-1536-5] RED first: assert the paired unit
...
- [x] T009 Implement the shared param-list renderer on
...
- [x] T010 Full-suite verification: `dart analyze` (changed files, no
