...
class Todo {
  ...
  Todo copyWithField<T>(Field<Todo, T> field, T value) {
    switch (field.name) {
      ...
      case 'priority':
        return copyWith(priority: value as int);
      case 'tags':
...
class TodoPatch extends PatchBase<Todo, Todo$> {
  ...
  TodoPatch withPriority(int? value) {
...
abstract final class TodoFields {
  static const id = Field<Todo, String>('id', _$id);
  ...
  static const priority = Field<Todo, int>('priority', _$priority);
