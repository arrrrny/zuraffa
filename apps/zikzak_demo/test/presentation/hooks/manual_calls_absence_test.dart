...
void main() {
  test('C5: presentation layer contains zero manual engagement calls', () async {
    final presentationDir =
        Directory('${Directory.current.path}/lib/src/presentation');
    expect(
    ...
    await for (final entity
        in presentationDir.list(recursive: true, followLinks: false)) {
