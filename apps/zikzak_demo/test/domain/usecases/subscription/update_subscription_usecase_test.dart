...
import 'package:zikzak_demo/src/domain/usecases/subscription/update_subscription_usecase.dart';
...
void main() {
  ...
  late UpdateSubscriptionUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    throwingUseCase = UpdateSubscriptionUseCase(throwingRepository);
  });
  group('UpdateSubscriptionUseCase', () {
    ...
    test('should call repository.update and return result', () async {
      final result = await useCase.call(
        UpdateParams<String, SubscriptionPatch>(
          id: tSubscription.id,
