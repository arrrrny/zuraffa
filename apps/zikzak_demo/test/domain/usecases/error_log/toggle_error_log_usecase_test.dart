...
import 'package:zikzak_demo/src/domain/usecases/error_log/toggle_error_log_usecase.dart';
...
void main() {
  late ToggleErrorLogUseCase useCase;
  late ToggleErrorLogUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = ToggleErrorLogUseCase(repository);
    throwingUseCase = ToggleErrorLogUseCase(throwingRepository);
  });
  group('ToggleErrorLogUseCase', () {
