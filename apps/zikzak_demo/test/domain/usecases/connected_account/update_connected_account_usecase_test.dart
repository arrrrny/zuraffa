...
import 'package:zikzak_demo/src/domain/usecases/connected_account/update_connected_account_usecase.dart';
...
void main() {
  late UpdateConnectedAccountUseCase useCase;
  late UpdateConnectedAccountUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = UpdateConnectedAccountUseCase(repository);
    throwingUseCase = UpdateConnectedAccountUseCase(throwingRepository);
  });
  group('UpdateConnectedAccountUseCase', () {
    ...
    test('should call repository.update and return result', () async {
      final result = await useCase.call(
        UpdateParams<String, ConnectedAccountPatch>(
