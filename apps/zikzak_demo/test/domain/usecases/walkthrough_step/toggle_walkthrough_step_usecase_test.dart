...
import 'package:zikzak_demo/src/domain/usecases/walkthrough_step/toggle_walkthrough_step_usecase.dart';
...
void main() {
  late ToggleWalkthroughStepUseCase useCase;
  late ToggleWalkthroughStepUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = ToggleWalkthroughStepUseCase(repository);
    throwingUseCase = ToggleWalkthroughStepUseCase(throwingRepository);
  });
  group('ToggleWalkthroughStepUseCase', () {
    ...
    test('should call repository.toggle and return result', () async {
      final result = await useCase.call(
        ToggleParams<String, Field<WalkthroughStep, dynamic>>(
          ...
          field: WalkthroughStepFields.id,
          value: 'toggled',
        ),
      );
