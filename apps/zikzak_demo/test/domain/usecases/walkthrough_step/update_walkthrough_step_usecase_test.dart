...
import 'package:zikzak_demo/src/domain/usecases/walkthrough_step/update_walkthrough_step_usecase.dart';
...
void main() {
  late UpdateWalkthroughStepUseCase useCase;
  late UpdateWalkthroughStepUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = UpdateWalkthroughStepUseCase(repository);
    throwingUseCase = UpdateWalkthroughStepUseCase(throwingRepository);
  });
  group('UpdateWalkthroughStepUseCase', () {
    ...
    test('should call repository.update and return result', () async {
      final result = await useCase.call(
        UpdateParams<String, WalkthroughStepPatch>(
          id: tWalkthroughStep.id,
          data: WalkthroughStepPatch(),
        ),
      );
