...
import 'package:zikzak_demo/src/domain/usecases/price_check_invoice/update_price_check_invoice_usecase.dart';
...
void main() {
  late UpdatePriceCheckInvoiceUseCase useCase;
  late UpdatePriceCheckInvoiceUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = UpdatePriceCheckInvoiceUseCase(repository);
    throwingUseCase = UpdatePriceCheckInvoiceUseCase(throwingRepository);
  });
  group('UpdatePriceCheckInvoiceUseCase', () {
