...
import 'package:zikzak_demo/src/domain/usecases/authentication/update_authentication_usecase.dart';
...
void main() {
  late UpdateAuthenticationUseCase useCase;
  late UpdateAuthenticationUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = UpdateAuthenticationUseCase(repository);
    throwingUseCase = UpdateAuthenticationUseCase(throwingRepository);
  });
  group('UpdateAuthenticationUseCase', () {
    ...
    test('should call repository.update and return result', () async {
      final result = await useCase.call(
        UpdateParams<String, AuthenticationPatch>(
          id: tAuthentication.id,
          data: AuthenticationPatch(),
        ),
      );
