...
import 'package:zikzak_demo/src/domain/usecases/customer_address/update_customer_address_usecase.dart';
...
void main() {
  late UpdateCustomerAddressUseCase useCase;
  late UpdateCustomerAddressUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    throwingUseCase = UpdateCustomerAddressUseCase(throwingRepository);
  });
  group('UpdateCustomerAddressUseCase', () {
    ...
    test('should call repository.update and return result', () async {
      final result = await useCase.call(
        UpdateParams<String, CustomerAddressPatch>(
          id: tCustomerAddress.id,
          data: CustomerAddressPatch(),
        ),
      );
