...
import 'package:zikzak_demo/src/domain/usecases/price_drop_notification/update_price_drop_notification_usecase.dart';
...
void main() {
  late UpdatePriceDropNotificationUseCase useCase;
  late UpdatePriceDropNotificationUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = UpdatePriceDropNotificationUseCase(repository);
    throwingUseCase = UpdatePriceDropNotificationUseCase(throwingRepository);
  });
  group('UpdatePriceDropNotificationUseCase', () {
    ...
    test('should call repository.update and return result', () async {
      final result = await useCase.call(
        UpdateParams<String, PriceDropNotificationPatch>(
          ...
          data: PriceDropNotificationPatch(),
        ),
      );
