...
import 'package:zikzak_demo/src/domain/usecases/user/update_user_usecase.dart';
...
void main() {
  ...
  late UpdateUserUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    throwingUseCase = UpdateUserUseCase(throwingRepository);
  });
  group('UpdateUserUseCase', () {
    ...
    test('should call repository.update and return result', () async {
      final result = await useCase.call(
        UpdateParams<String, UserPatch>(id: tUser.id, data: UserPatch()),
      );
