...
import 'package:zikzak_demo/src/domain/usecases/walkthrough/toggle_walkthrough_usecase.dart';
...
void main() {
  late ToggleWalkthroughUseCase useCase;
  late ToggleWalkthroughUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = ToggleWalkthroughUseCase(repository);
    throwingUseCase = ToggleWalkthroughUseCase(throwingRepository);
  });
  group('ToggleWalkthroughUseCase', () {
