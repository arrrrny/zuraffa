...
import 'package:zikzak_demo/src/domain/usecases/zik_zak_score/toggle_zik_zak_score_usecase.dart';
...
void main() {
  late ToggleZikZakScoreUseCase useCase;
  late ToggleZikZakScoreUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = ToggleZikZakScoreUseCase(repository);
    throwingUseCase = ToggleZikZakScoreUseCase(throwingRepository);
  });
  group('ToggleZikZakScoreUseCase', () {
