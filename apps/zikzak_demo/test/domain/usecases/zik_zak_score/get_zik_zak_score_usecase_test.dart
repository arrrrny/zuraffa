...
import 'package:zikzak_demo/src/domain/usecases/zik_zak_score/get_zik_zak_score_usecase.dart';
...
void main() {
  late GetZikZakScoreUseCase useCase;
  late GetZikZakScoreUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = GetZikZakScoreUseCase(repository);
    throwingUseCase = GetZikZakScoreUseCase(throwingRepository);
  });
  group('GetZikZakScoreUseCase', () {
    final tZikZakScore = ZikZakScoreMockData.sampleZikZakScore;
    test('should call repository.get and return result', () async {
      final result = await useCase.call(
        QueryParams<ZikZakScore>(
          filter: Eq(ZikZakScoreFields.id, tZikZakScore.id),
        ),
      );
