...
import 'package:zikzak_demo/src/domain/usecases/grocery_product/toggle_grocery_product_usecase.dart';
...
void main() {
  late ToggleGroceryProductUseCase useCase;
  late ToggleGroceryProductUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = ToggleGroceryProductUseCase(repository);
    throwingUseCase = ToggleGroceryProductUseCase(throwingRepository);
  });
  group('ToggleGroceryProductUseCase', () {
