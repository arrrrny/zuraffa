...
import 'package:zikzak_demo/src/domain/usecases/form_submission/toggle_form_submission_usecase.dart';
...
void main() {
  late ToggleFormSubmissionUseCase useCase;
  late ToggleFormSubmissionUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = ToggleFormSubmissionUseCase(repository);
    throwingUseCase = ToggleFormSubmissionUseCase(throwingRepository);
  });
  group('ToggleFormSubmissionUseCase', () {
