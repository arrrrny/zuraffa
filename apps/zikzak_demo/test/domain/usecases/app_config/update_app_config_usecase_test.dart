...
import 'package:zikzak_demo/src/domain/usecases/app_config/update_app_config_usecase.dart';
...
void main() {
  late UpdateAppConfigUseCase useCase;
  late UpdateAppConfigUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = UpdateAppConfigUseCase(repository);
    throwingUseCase = UpdateAppConfigUseCase(throwingRepository);
  });
  group('UpdateAppConfigUseCase', () {
    final tAppConfig = AppConfigMockData.sampleAppConfig;
    test('should call repository.update and return result', () async {
      final result = await useCase.call(
        UpdateParams<String, AppConfigPatch>(
          id: tAppConfig.id,
          data: AppConfigPatch(),
        ),
      );
