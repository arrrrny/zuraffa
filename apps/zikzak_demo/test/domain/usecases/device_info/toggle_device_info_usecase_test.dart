...
import 'package:zikzak_demo/src/domain/usecases/device_info/toggle_device_info_usecase.dart';
...
void main() {
  late ToggleDeviceInfoUseCase useCase;
  late ToggleDeviceInfoUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = ToggleDeviceInfoUseCase(repository);
    throwingUseCase = ToggleDeviceInfoUseCase(throwingRepository);
  });
  group('ToggleDeviceInfoUseCase', () {
    ...
    test('should call repository.toggle and return result', () async {
      final result = await useCase.call(
        ToggleParams<String, Field<DeviceInfo, dynamic>>(
          ...
          field: DeviceInfoFields.deviceId,
          value: 'toggled',
        ),
      );
