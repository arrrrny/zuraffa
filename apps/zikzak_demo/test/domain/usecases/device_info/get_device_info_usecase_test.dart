...
import 'package:zikzak_demo/src/domain/usecases/device_info/get_device_info_usecase.dart';
...
void main() {
  ...
  late GetDeviceInfoUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = GetDeviceInfoUseCase(repository);
    throwingUseCase = GetDeviceInfoUseCase(throwingRepository);
  });
    ...
    test('should call repository.get and return result', () async {
      final result = await useCase.call(
        QueryParams<DeviceInfo>(
          filter: Eq(DeviceInfoFields.deviceId, tDeviceInfo.deviceId),
        ),
      );
