...
import 'package:zikzak_demo/src/domain/usecases/locale/update_locale_usecase.dart';
...
void main() {
  ...
  late UpdateLocaleUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    throwingUseCase = UpdateLocaleUseCase(throwingRepository);
  });
  group('UpdateLocaleUseCase', () {
    ...
    test('should call repository.update and return result', () async {
      final result = await useCase.call(
        UpdateParams<String, LocalePatch>(id: tLocale.id, data: LocalePatch()),
      );
