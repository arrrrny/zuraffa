...
import 'package:zikzak_demo/src/domain/usecases/text_listing/toggle_text_listing_usecase.dart';
...
void main() {
  late ToggleTextListingUseCase useCase;
  late ToggleTextListingUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = ToggleTextListingUseCase(repository);
    throwingUseCase = ToggleTextListingUseCase(throwingRepository);
  });
  group('ToggleTextListingUseCase', () {
