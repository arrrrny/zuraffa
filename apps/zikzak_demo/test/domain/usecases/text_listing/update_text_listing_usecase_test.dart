...
import 'package:zikzak_demo/src/domain/usecases/text_listing/update_text_listing_usecase.dart';
...
void main() {
  late UpdateTextListingUseCase useCase;
  late UpdateTextListingUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = UpdateTextListingUseCase(repository);
    throwingUseCase = UpdateTextListingUseCase(throwingRepository);
  });
  group('UpdateTextListingUseCase', () {
    final tTextListing = TextListingMockData.sampleTextListing;
    test('should call repository.update and return result', () async {
      final result = await useCase.call(
        UpdateParams<String, TextListingPatch>(
          id: tTextListing.id,
          data: TextListingPatch(),
        ),
      );
