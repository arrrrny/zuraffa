...
import 'package:zikzak_demo/src/domain/usecases/grocery_price_result/get_grocery_price_result_usecase.dart';
...
void main() {
  late GetGroceryPriceResultUseCase useCase;
  late GetGroceryPriceResultUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = GetGroceryPriceResultUseCase(repository);
    throwingUseCase = GetGroceryPriceResultUseCase(throwingRepository);
  });
  group('GetGroceryPriceResultUseCase', () {
    ...
    test('should call repository.get and return result', () async {
      final result = await useCase.call(
        QueryParams<GroceryPriceResult>(
          filter: Eq(
            GroceryPriceResultFields.storeName,
            tGroceryPriceResult.storeName,
          ),
        ),
      );
