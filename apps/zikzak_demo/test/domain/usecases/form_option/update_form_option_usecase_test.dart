...
import 'package:zikzak_demo/src/domain/usecases/form_option/update_form_option_usecase.dart';
...
void main() {
  late UpdateFormOptionUseCase useCase;
  late UpdateFormOptionUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = UpdateFormOptionUseCase(repository);
    throwingUseCase = UpdateFormOptionUseCase(throwingRepository);
  });
  group('UpdateFormOptionUseCase', () {
    final tFormOption = FormOptionMockData.sampleFormOption;
    test('should call repository.update and return result', () async {
      final result = await useCase.call(
        UpdateParams<String, FormOptionPatch>(
          id: tFormOption.id,
          data: FormOptionPatch(),
        ),
      );
