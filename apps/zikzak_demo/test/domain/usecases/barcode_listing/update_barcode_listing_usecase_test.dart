...
import 'package:zikzak_demo/src/domain/usecases/barcode_listing/update_barcode_listing_usecase.dart';
...
void main() {
  late UpdateBarcodeListingUseCase useCase;
  late UpdateBarcodeListingUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = UpdateBarcodeListingUseCase(repository);
    throwingUseCase = UpdateBarcodeListingUseCase(throwingRepository);
  });
  group('UpdateBarcodeListingUseCase', () {
    ...
    test('should call repository.update and return result', () async {
      final result = await useCase.call(
        UpdateParams<String, BarcodeListingPatch>(
          id: tBarcodeListing.id,
          data: BarcodeListingPatch(),
        ),
      );
