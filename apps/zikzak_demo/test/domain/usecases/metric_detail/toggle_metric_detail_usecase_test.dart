...
import 'package:zikzak_demo/src/domain/usecases/metric_detail/toggle_metric_detail_usecase.dart';
...
void main() {
  late ToggleMetricDetailUseCase useCase;
  late ToggleMetricDetailUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = ToggleMetricDetailUseCase(repository);
    throwingUseCase = ToggleMetricDetailUseCase(throwingRepository);
  });
  group('ToggleMetricDetailUseCase', () {
