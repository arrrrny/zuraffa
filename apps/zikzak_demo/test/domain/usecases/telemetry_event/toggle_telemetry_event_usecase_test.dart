...
import 'package:zikzak_demo/src/domain/usecases/telemetry_event/toggle_telemetry_event_usecase.dart';
...
void main() {
  late ToggleTelemetryEventUseCase useCase;
  late ToggleTelemetryEventUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = ToggleTelemetryEventUseCase(repository);
    throwingUseCase = ToggleTelemetryEventUseCase(throwingRepository);
  });
  group('ToggleTelemetryEventUseCase', () {
