...
import 'package:zikzak_demo/src/domain/usecases/chat_session/update_chat_session_usecase.dart';
...
void main() {
  late UpdateChatSessionUseCase useCase;
  late UpdateChatSessionUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = UpdateChatSessionUseCase(repository);
    throwingUseCase = UpdateChatSessionUseCase(throwingRepository);
  });
  group('UpdateChatSessionUseCase', () {
    final tChatSession = ChatSessionMockData.sampleChatSession;
    test('should call repository.update and return result', () async {
      final result = await useCase.call(
        UpdateParams<String, ChatSessionPatch>(
          id: tChatSession.id,
