...
import 'package:zikzak_demo/src/domain/usecases/url_listing/update_url_listing_usecase.dart';
...
void main() {
  late UpdateUrlListingUseCase useCase;
  late UpdateUrlListingUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    useCase = UpdateUrlListingUseCase(repository);
    throwingUseCase = UpdateUrlListingUseCase(throwingRepository);
  });
  group('UpdateUrlListingUseCase', () {
    final tUrlListing = UrlListingMockData.sampleUrlListing;
    test('should call repository.update and return result', () async {
      final result = await useCase.call(
        UpdateParams<String, UrlListingPatch>(
          id: tUrlListing.id,
          data: UrlListingPatch(),
        ),
      );
