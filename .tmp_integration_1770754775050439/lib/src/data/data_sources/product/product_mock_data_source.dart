...
class ProductMockDataSource with Loggable, FailureHandler implements ProductDataSource {
  ...
  @override
  Future<Product> update(UpdateParams<String, Map<String, dynamic>> params) async {
