// Generated by zfa
// zfa generate Product --methods=get,getList,create,update,delete,watchList --state
...
class ProductState {
  ...
  bool get isLoading => isGetting || isGettingList || isCreating || isUpdating || isDeleting || isWatchingList;
  ...
  bool operator ==(Object other) =>
      ...
      (other is ProductState &&
          ...
          error == other.error && isGetting == other.isGetting && isGettingList == other.isGettingList && isCreating == other.isCreating && isUpdating == other.isUpdating && isDeleting == other.isDeleting && isWatchingList == other.isWatchingList);
