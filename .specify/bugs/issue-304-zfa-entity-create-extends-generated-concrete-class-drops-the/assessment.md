# Bug Assessment: zfa entity create --extends: generated concrete class drops the implements clause from the source abstract class

- **Slug**: issue-304-zfa-entity-create-extends-generated-concrete-class-drops-the
- **Created**: 2026-08-22T19:42:20.566186+00:00
- **Source**: https://github.com/arrrrny/zuraffa/issues/304
- **Verdict**: likely valid, needs reproduction
- **Severity**: unknown

## Report (verbatim or summarized)

zfa entity create --extends: generated concrete class drops the implements clause from the source abstract class — see https://github.com/arrrrny/zuraffa/issues/304.
