# Bug Issue: zfa api <Entity> CLI command is dead code (subcommand gate)

- **Slug**: zfa-api-entity-cli-command-is-dead-code-subcommand-gate
- **Fetched**: 2026-08-27T14:26:43.477146+00:00
- **Issue**: 494
- **URL**: https://github.com/arrrrny/zuraffa/issues/494
- **State**: open
- **Severity**: unknown
- **Author**: arrrrny
- **Labels**: bug
