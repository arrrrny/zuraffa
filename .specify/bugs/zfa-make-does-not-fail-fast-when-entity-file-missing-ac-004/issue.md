# Bug Issue: zfa make does not fail fast when entity file missing (AC-004)

- **Slug**: zfa-make-does-not-fail-fast-when-entity-file-missing-ac-004
- **Fetched**: 2026-08-27T14:26:42.487376+00:00
- **Issue**: 496
- **URL**: https://github.com/arrrrny/zuraffa/issues/496
- **State**: open
- **Severity**: unknown
- **Author**: arrrrny
- **Labels**: bug
