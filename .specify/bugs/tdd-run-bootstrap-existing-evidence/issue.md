# Issue #682: [zfa tdd run] cannot bootstrap from existing evidence (run-state.json starts all pending even when all done)

- **State**: open
- **Fetched from**: https://github.com/arrrrny/zuraffa/issues/682
- **Fetched at**: 2026-09-01
