...
**high** — `zfa tdd verify-red` and `zfa tdd make` fail on ALL existing projects that have the ecosystem-detected frontmatter format. `zfa tdd run` is completely blocked.
