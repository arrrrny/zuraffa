# Bug Issue: dart analyze produces 2010 errors on dart-only installations

- **Slug**: dart-analyze-produces-2010-errors-on-dart-only-installations
- **Fetched**: 2026-08-27T14:26:38.214699+00:00
- **Issue**: 512
- **URL**: https://github.com/arrrrny/zuraffa/issues/512
- **State**: open
- **Severity**: unknown
- **Author**: arrrrny
- **Labels**: bug
