---
name: "speckit.zuraffa.datasource.method"
description: "Append method to existing datasource"
category: "data"
---

# Method: Append method to existing datasource

## Usage

```bash
zfa datasource method
```

## When to Use

Append method to existing datasource
