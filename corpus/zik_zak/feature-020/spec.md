...
The 020 feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Message when the user commits the 020 form.
  traces: `MessageRepo.save`
- **FR-002**: The system MUST restore the last 020 state on cold start.
  traces: `Hive.put`, `MessageRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open 020 **Then** the saved Message list renders.
   **Type**: widget
2. **Given** an empty local cache **When** 020 loads **Then** the placeholder renders.
   **Type**: widget
