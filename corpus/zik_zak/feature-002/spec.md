...
The 002 feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Profile when the user commits the 002 form.
  traces: `ProfileRepo.save`
- **FR-002**: The system MUST restore the last 002 state on cold start.
  traces: `Hive.put`, `ProfileRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open 002 **Then** the saved Profile list renders.
   **Type**: widget
2. **Given** an empty local cache **When** 002 loads **Then** the placeholder renders.
   **Type**: widget
