...
# Spec: Category Browse

## Summary

The Category Browse feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Wallet when the user commits the Category Browse form.
  traces: `WalletRepo.save`
- **FR-002**: The system MUST restore the last Category Browse state on cold start.
  traces: `Hive.put`, `WalletRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open Category Browse **Then** the saved Wallet list renders.
   **Type**: widget
2. **Given** an empty local cache **When** Category Browse loads **Then** the placeholder renders.
   **Type**: widget
