...
The 037 feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Session when the user commits the 037 form.
- **FR-002**: The system MUST restore the last 037 state on cold start.

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open 037 **Then** the saved Session list renders.
2. **Given** an empty local cache **When** 037 loads **Then** the placeholder renders.
