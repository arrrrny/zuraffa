...
The 058 feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Coupon when the user commits the 058 form.
  traces: `CouponRepo.save`
- **FR-002**: The system MUST restore the last 058 state on cold start.
  traces: `Hive.put`, `CouponRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open 058 **Then** the saved Coupon list renders.
   **Type**: widget
2. **Given** an empty local cache **When** 058 loads **Then** the placeholder renders.
   **Type**: widget
