...
| -- | -- | -- |
| FR-001 | The system MUST list Order rows for Analytics Tap. | — |
| | variant: offline — the cached list renders. | v1 |
| | variant: empty — the placeholder renders. | v2 |
| FR-002 | The system MUST refresh the Analytics Tap list on pull. | — |

## Acceptance Scenarios

1. **Given** cached rows **When** Analytics Tap opens offline **Then** the cached list renders.
   **Type**: widget
