...
The Trending feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Order when the user commits the Trending form.
  traces: `OrderRepo.save`
- **FR-002**: The system MUST restore the last Trending state on cold start.
  traces: `Hive.put`, `OrderRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open Trending **Then** the saved Order list renders.
   **Type**: widget
2. **Given** an empty local cache **When** Trending loads **Then** the placeholder renders.
   **Type**: widget
