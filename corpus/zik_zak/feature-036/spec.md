...
The 036 feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Report when the user commits the 036 form.
- **FR-002**: The system MUST restore the last 036 state on cold start.

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open 036 **Then** the saved Report list renders.
2. **Given** an empty local cache **When** 036 loads **Then** the placeholder renders.
