...
The Deal Detail feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Receipt when the user commits the Deal Detail form.
  traces: `ReceiptRepo.save`
- **FR-002**: The system MUST restore the last Deal Detail state on cold start.
  traces: `Hive.put`, `ReceiptRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open Deal Detail **Then** the saved Receipt list renders.
   **Type**: widget
2. **Given** an empty local cache **When** Deal Detail loads **Then** the placeholder renders.
   **Type**: widget
