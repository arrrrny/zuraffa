...
| -- | -- | -- |
| FR-001 | The system MUST list Coupon rows for Remote Config. | — |
| | variant: offline — the cached list renders. | v1 |
| | variant: empty — the placeholder renders. | v2 |
| FR-002 | The system MUST refresh the Remote Config list on pull. | — |

## Acceptance Scenarios

1. **Given** cached rows **When** Remote Config opens offline **Then** the cached list renders.
   **Type**: widget
