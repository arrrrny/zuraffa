...
The Price History feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Bookmark when the user commits the Price History form.
  traces: `BookmarkRepo.save`
- **FR-002**: The system MUST restore the last Price History state on cold start.
  traces: `Hive.put`, `BookmarkRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open Price History **Then** the saved Bookmark list renders.
   **Type**: widget
2. **Given** an empty local cache **When** Price History loads **Then** the placeholder renders.
   **Type**: widget
