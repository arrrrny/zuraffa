...
The 054 feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Bookmark when the user commits the 054 form.
  traces: `BookmarkRepo.save`
- **FR-002**: The system MUST restore the last 054 state on cold start.
  traces: `Hive.put`, `BookmarkRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open 054 **Then** the saved Bookmark list renders.
   **Type**: widget
2. **Given** an empty local cache **When** 054 loads **Then** the placeholder renders.
   **Type**: widget
