...
The Theme Picker feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Order when the user commits the Theme Picker form.
  traces: `OrderRepo.save`
- **FR-002**: The system MUST restore the last Theme Picker state on cold start.
  traces: `Hive.put`, `OrderRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open Theme Picker **Then** the saved Order list renders.
   **Type**: widget
2. **Given** an empty local cache **When** Theme Picker loads **Then** the placeholder renders.
   **Type**: widget
