...
The Qr Scan feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Report when the user commits the Qr Scan form.
  traces: `ReportRepo.save`
- **FR-002**: The system MUST restore the last Qr Scan state on cold start.
  traces: `Hive.put`, `ReportRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open Qr Scan **Then** the saved Report list renders.
   **Type**: widget
2. **Given** an empty local cache **When** Qr Scan loads **Then** the placeholder renders.
   **Type**: widget
