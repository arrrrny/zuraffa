...
The 011 feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Ticket when the user commits the 011 form.
  traces: `TicketRepo.save`
- **FR-002**: The system MUST restore the last 011 state on cold start.
  traces: `Hive.put`, `TicketRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open 011 **Then** the saved Ticket list renders.
   **Type**: widget
2. **Given** an empty local cache **When** 011 loads **Then** the placeholder renders.
   **Type**: widget
