...
- **FR-001**: The system MUST validate the Account Deletion form before submit.
...
1.2. **Given** a saved Receipt **When** the user reopens Account Deletion **Then** the row renders.
