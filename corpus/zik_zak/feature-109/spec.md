...
The 109 feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Session when the user commits the 109 form.
  traces: `SessionRepo.save`
- **FR-002**: The system MUST restore the last 109 state on cold start.
  traces: `Hive.put`, `SessionRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open 109 **Then** the saved Session list renders.
2. **Given** an empty local cache **When** 109 loads **Then** the placeholder renders.
