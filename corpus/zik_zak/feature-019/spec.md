...
The 019 feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Alert when the user commits the 019 form.
  traces: `AlertRepo.save`
- **FR-002**: The system MUST restore the last 019 state on cold start.
  traces: `Hive.put`, `AlertRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open 019 **Then** the saved Alert list renders.
   **Type**: widget
2. **Given** an empty local cache **When** 019 loads **Then** the placeholder renders.
   **Type**: widget
