# Spec: Biometric Unlock

**Template Version**: `zuraffa-1.0`

## Functional Requirements

- **FR-001**: The system MUST validate the Biometric Unlock form before submit.
...
1.2. **Given** a saved Profile **When** the user reopens Biometric Unlock **Then** the row renders.
