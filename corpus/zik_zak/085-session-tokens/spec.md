...
- **FR-001**: The system MUST validate the Session Tokens form before submit.
...
1.2. **Given** a saved Session **When** the user reopens Session Tokens **Then** the row renders.
