...
The Conflict Resolution feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Coupon when the user commits the Conflict Resolution form.
  traces: `CouponRepo.save`
- **FR-002**: The system MUST restore the last Conflict Resolution state on cold start.
  traces: `Hive.put`, `CouponRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open Conflict Resolution **Then** the saved Coupon list renders.
   **Type**: widget
2. **Given** an empty local cache **When** Conflict Resolution loads **Then** the placeholder renders.
   **Type**: widget
