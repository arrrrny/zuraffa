...
The 035 feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Ticket when the user commits the 035 form.
- **FR-002**: The system MUST restore the last 035 state on cold start.

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open 035 **Then** the saved Ticket list renders.
2. **Given** an empty local cache **When** 035 loads **Then** the placeholder renders.
