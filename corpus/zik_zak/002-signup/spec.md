...
The Signup feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Profile when the user commits the Signup form.
  traces: `ProfileRepo.save`
- **FR-002**: The system MUST restore the last Signup state on cold start.
  traces: `Hive.put`, `ProfileRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open Signup **Then** the saved Profile list renders.
   **Type**: widget
2. **Given** an empty local cache **When** Signup loads **Then** the placeholder renders.
   **Type**: widget
