...
The Wallet Balance feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Session when the user commits the Wallet Balance form.
- **FR-002**: The system MUST restore the last Wallet Balance state on cold start.

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open Wallet Balance **Then** the saved Session list renders.
2. **Given** an empty local cache **When** Wallet Balance loads **Then** the placeholder renders.
