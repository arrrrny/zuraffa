...
The 001 feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Session when the user commits the 001 form.
  traces: `SessionRepo.save`
- **FR-002**: The system MUST restore the last 001 state on cold start.
  traces: `Hive.put`, `SessionRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open 001 **Then** the saved Session list renders.
   **Type**: widget
2. **Given** an empty local cache **When** 001 loads **Then** the placeholder renders.
   **Type**: widget
