...
The 010 feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Coupon when the user commits the 010 form.
  traces: `CouponRepo.save`
- **FR-002**: The system MUST restore the last 010 state on cold start.
  traces: `Hive.put`, `CouponRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open 010 **Then** the saved Coupon list renders.
   **Type**: widget
2. **Given** an empty local cache **When** 010 loads **Then** the placeholder renders.
   **Type**: widget
