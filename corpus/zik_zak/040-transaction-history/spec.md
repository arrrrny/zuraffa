...
The Transaction History feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Order when the user commits the Transaction History form.
- **FR-002**: The system MUST restore the last Transaction History state on cold start.

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open Transaction History **Then** the saved Order list renders.
2. **Given** an empty local cache **When** Transaction History loads **Then** the placeholder renders.
