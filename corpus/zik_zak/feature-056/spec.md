...
The 056 feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Message when the user commits the 056 form.
  traces: `MessageRepo.save`
- **FR-002**: The system MUST restore the last 056 state on cold start.
  traces: `Hive.put`, `MessageRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open 056 **Then** the saved Message list renders.
   **Type**: widget
2. **Given** an empty local cache **When** 056 loads **Then** the placeholder renders.
   **Type**: widget
