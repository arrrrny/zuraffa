...
The Wallet Topup feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Profile when the user commits the Wallet Topup form.
- **FR-002**: The system MUST restore the last Wallet Topup state on cold start.

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open Wallet Topup **Then** the saved Profile list renders.
2. **Given** an empty local cache **When** Wallet Topup loads **Then** the placeholder renders.
