...
The 024 feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Report when the user commits the 024 form.
  traces: `ReportRepo.save`
- **FR-002**: The system MUST restore the last 024 state on cold start.
  traces: `Hive.put`, `ReportRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open 024 **Then** the saved Report list renders.
   **Type**: widget
2. **Given** an empty local cache **When** 024 loads **Then** the placeholder renders.
   **Type**: widget
