...
The 113 feature, as the ZikZak app ships it.
...
- **FR-001**: The system MUST save a Receipt when the user commits the 113 form.
  traces: `ReceiptRepo.save`
- **FR-002**: The system MUST restore the last 113 state on cold start.
  traces: `Hive.put`, `ReceiptRepo.get`

## Acceptance Scenarios

1. **Given** a signed-in user **When** they open 113 **Then** the saved Receipt list renders.
   **Type**: widget
2. **Given** an empty local cache **When** 113 loads **Then** the placeholder renders.
   **Type**: widget
