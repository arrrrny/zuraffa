...
- **iOS deployment target**: the zuraffa SPM packages require iOS 15.6+;
  `zfa setup` hosts default to 15.0 — bump `IPHONEOS_DEPLOYMENT_TARGET`
  to 15.6 in `ios/Runner.xcodeproj/project.pbxproj` (three occurrences).
