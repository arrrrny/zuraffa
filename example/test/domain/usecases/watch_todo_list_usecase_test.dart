...
import 'package:example/src/domain/usecases/watch_todo_list_usecase.dart';
...
void main() {
  ...
  setUp(() {
    registerFallbackValue(ListQueryParams<Todo>());
  ...
  group('WatchTodoListUseCase', () {
    ...
    test('should emit values from repository stream', () async {
      // Arrange
      when(() => mockRepository.watchList(any())).thenAnswer(
        (_) => Stream.value(tTodoList),
      );
