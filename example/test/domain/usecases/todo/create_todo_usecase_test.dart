...
void main() {
  ...
  late CreateTodoUseCase throwingUseCase;
  ...
  setUp(() {
    ...
    throwingUseCase = CreateTodoUseCase(throwingRepository);
  });
  group('CreateTodoUseCase', () {
    final tTodo = TodoMockData.sampleTodo;
    test('should call repository.create and return result', () async {
      final result = await useCase.call(tTodo);
      expect(result.isSuccess, true);
    });
    test('should return Failure when repository throws', () async {
      final result = await throwingUseCase.call(tTodo);
