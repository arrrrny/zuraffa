...
import 'package:example/src/domain/usecases/watch_todo_usecase.dart';
...
void main() {
  ...
  setUp(() {
    registerFallbackValue(QueryParams<Todo>());
  ...
  group('WatchTodoUseCase', () {
    ...
    test('should emit values from repository stream', () async {
      // Arrange
      when(() => mockRepository.watch(any())).thenAnswer(
        (_) => Stream.value(tTodo),
      );

      // Act
      final result = useCase(
        QueryParams<Todo>(filter: Eq(TodoFields.id, 1)),
      );
