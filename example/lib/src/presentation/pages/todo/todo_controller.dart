// Generated by zfa
// zfa generate Todo --methods=get,watch,create,update,delete,getList,watchList --vpc --state
...
class TodoController extends Controller with StatefulController<TodoState> {
  ...
  Future<void> createTodo(Todo todo) async {
    ...
    result.fold(
      (created) => updateState(viewState.copyWith(
        isCreating: false,
        todoList: [...viewState.todoList, created],
      )),
      (failure) => updateState(viewState.copyWith(
        isCreating: false,
        error: failure,
  ...
  Future<void> toggleTodo(int id) async {
    ...
    if (todo != null) {
      ...
      await updateTodo(id.toString(), {'isCompleted': updated.isCompleted});
    }
  }
