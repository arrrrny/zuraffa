...
Future<void> subject_a4() async {
  ...
  expect(binding.auditRows, hasLength(2));
  expect(binding.auditRows[0].row, 'error-toaster');
  expect(binding.auditRows[0].kind, 'observer');
  expect(binding.auditRows[1].row, 'error-inline');
  expect(binding.auditRows[1].kind, 'listener');
}
