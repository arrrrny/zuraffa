// GENERATED IMPLEMENTATION — `zfa tdd compose A5` (issue
...
// description: the generated mock conforms to the storage contract the row declares (the rail is dependency-kind-agnostic across the declared service and storage kinds).
//
...
/// Subject for behavior A5, composed against the
/// feature's unit subject anchors by the generation pipeline.
void subject_a5() {  // Composition anchor: references the feature's green / entity-wired unit
