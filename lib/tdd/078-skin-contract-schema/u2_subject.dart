// GENERATED TEST SUBJECT — `zfa tdd gen U2` (spec 044-test-tdd-generation).
//
// behavior_id: U2
...
/// Scenario runner for behavior U2.
Future<void> subject_u2() async {
  final unknown = validContractJson.replaceFirst(
    '\n  ]\n}',
    '\n  ],\n  "rogueSection": []\n}',
  );
  expect(
    () => parseSkinContractJson(unknown),
    throwsA(
