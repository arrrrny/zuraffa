...
List<DeclaredSurface> fixtureSurfaces() => const [
  DeclaredSurface(surface: 'Login button text', kind: UiSurfaceKind.text, declaredProvers: ['A1']),
  DeclaredSurface(surface: '/login', kind: UiSurfaceKind.route, declaredProvers: ['A2']),
  DeclaredSurface(surface: 'submit form', kind: UiSurfaceKind.affordance, declaredProvers: ['A3']),
];
