...
class RunDriverCore {
  ...
  Future<RunDriverOutcome> drive({
    ...
    // carries the run's scratch-TMPDIR map for every step child. Issue
    // #1590: it also tees the child's stdout lines so the driver can
    // forward the make child's sub-step banners while the step runs.
