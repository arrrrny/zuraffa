...
class MockFeatureCapability implements ZuraffaCapability {
  final FeaturePlugin plugin;

  MockFeatureCapability(this.plugin);

  @override
  String get name => 'mock';

  @override
  String get description => 'Add mock data to an existing feature';
  ...
  Future<List<GeneratedFile>> _generateFiles(
    ...
    return mockPlugin.generate(config);
  }
}
