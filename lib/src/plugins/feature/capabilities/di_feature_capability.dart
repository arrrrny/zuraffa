...
class DiFeatureCapability implements ZuraffaCapability {
  final FeaturePlugin plugin;

  DiFeatureCapability(this.plugin);

  @override
  String get name => 'di';

  @override
  String get description => 'Add dependency injection to an existing feature';
  ...
  Future<List<GeneratedFile>> _generateFiles(
    ...
    return diPlugin.generate(config);
  }
}
