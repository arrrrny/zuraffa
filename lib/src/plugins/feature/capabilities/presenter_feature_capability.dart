...
class PresenterFeatureCapability implements ZuraffaCapability {
  final FeaturePlugin plugin;

  PresenterFeatureCapability(this.plugin);

  @override
  String get name => 'presenter';

  @override
  String get description => 'Add presenter to an existing feature';
  ...
  Future<List<GeneratedFile>> _generateFiles(
    ...
    return presenterPlugin.generate(config);
  }
}
