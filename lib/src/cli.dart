/// Zuraffa CLI Tool
///
/// This file contains the command-line interface for the Zuraffa package.
...
/// flutter pub run zuraffa:cli create
///
/// # Create a specific page
/// flutter pub run zuraffa:cli create --page user_profile
///
/// # Show help
/// flutter pub run zuraffa:cli --help
/// ```
...
/// Main entry point for the Zuraffa CLI tool.
///
...
For more information about a specific command, run:
  flutter pub run zuraffa:cli <command> --help
''');
}
...
EXAMPLES:
  flutter pub run zuraffa:cli create --page user_profile
  flutter pub run zuraffa:cli create --page product_detail
  flutter pub run zuraffa:cli create
''');
}
