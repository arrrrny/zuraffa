...
''';
    ...
    for (final variant in config.variants) {
      ...
      final repoSnake = config.repo != null
          ...
          : '';
      final repoFieldName = repoClassName != null
          ? '_${repoSnake}Repository'
          : '';

      final repoField = repoClassName != null
          ? '  final $repoClassName $repoFieldName;'
          : '';
